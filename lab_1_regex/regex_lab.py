...
class RegexExercises:
    ...
    def rain():
        ...
        """
        return r"\b[rR]ain\w*\b"  # bordure de mot pour ne pas inclure "brains"
    ...
    def east():
        ...
        """
        return r"\b[eE]ast\b"  # bordure de mot pour ne pas inclure "eastern"
    ...
    def hyphenated():
        ...
        """
        return r"\b\w+(?:-\w+)+\b"  # un mot suivi d'un tiret et d'au moins un mot
